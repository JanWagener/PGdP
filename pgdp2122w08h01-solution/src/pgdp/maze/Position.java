...
public class Position {
    ...
    public boolean isAt(int iIn, int jIn) {
        return this.i == iIn && this.j == jIn;
    }
    ...
    /*  Eigene Implementierungen von hashCode() und equals(), damit Position-Objekt sinnvoll in einem HashSet
     *  (und ähnlichen Datenstrukturen) verwendet werden können.
     */
    @Override
    public int hashCode() {
        return i + j;
    ...
    /** Berechnet die Position ein Tile weiter in der übergebenen Richtung von 'this' aus.
     *
