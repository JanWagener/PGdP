...
public class Maze {
    ...
    public Maze(TileState[][] tiles, Position entrance, Position exit) {
        this.tiles = new TileState[tiles.length][tiles[0].length];
    ...
    /** Markiert das Feld an der übergebenen Position 'position'
     *  (D.h. der TileState wird auf MARKED gesetzt).
     *  Nur Felder mit TileState SPACE können markiert werden, keine WALLs.
     *
    ...
    /** Gibt eine String-Repräsentation des Labyrinths zurück.
     *  Dabei steht ein W für eine 'WALL', ein Leerzeichen für ein freies Feld ('SPACE')
     *  und ein ' für ein markiertes Feld ('MARKED').
     *  Außerdem steht E für den Eingang ('entrance') und X für den Ausgang ('exit')
     *  des Labyrinthes. Dabei wird E vor X vor den "normalen" Tiles gezeichnet.
     *
    ...
    /** Enum, das die möglichen Zustände eines Feldes speichert:
     *    WALL:     Eine Wand.
     *    SPACE:    Ein freies Feld.
     *    MARKED:   Ein markiertes Feld.
     */
    enum TileState {
        WALL, SPACE, MARKED
    }
